...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row login-row">
            {!! Form::model($allocation, array('route' => array('allocations.update', $allocation->user_id), 'method' => 'POST')) !!}

            <div class="form-group  {{ $errors->has('monthly_salary') ? 'has-error' : '' }}">
                {!! Form::label('productivity', 'Productivity', array('class' => 'control-label')) !!}
                <div class="controls">
                     <input type="number" class="form-control" id="productivity" name="productivity" value={{$allocation->productivity}}>
            ...
            <div class="form-group  {{ $errors->has('investments') ? 'has-error' : '' }}">
                ...
                <div class="controls">
                    <input type="number" class="form-control" id="investments" name="investments" value={{$allocation->investments}}>
            ...
            <div class="form-group  {{ $errors->has('savings') ? 'has-error' : '' }}">
                ...
                <div class="controls">
                    <input type="number" class="form-control" id="savings" name="savings" value={{$allocation->savings}}>
            ...
            <div class="form-group  {{ $errors->has('charities') ? 'has-error' : '' }}">
                ...
                <div class="controls">
                    <input type="number" class="form-control" id="charities" name="charities" value={{$allocation->charities}}>
